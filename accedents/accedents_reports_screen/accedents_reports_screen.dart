...
class _AccedentsReportsScreenState extends State<AccedentsReportsScreen>
    with AccedentsReportsData {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    dailyFactsPagingController.addPageRequestListener((pageKey) {
      fetchPageDailyFacts(pageKey);
    });
    carAccedentPagingController.addPageRequestListener((pageKey) {
      fetchPageCarAccedent(pageKey);
    });
    initData();
  }
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                goToScreen(
                                    screenNames: ScreenNames.addAccedentsScreen,
                                    arguments: initData);
                              },
                              child: Container(
